                    ...
                    Group {
                        ...
                        case .wristFlexion:
                            ...
                            if viewModel.exercise?.hand == true {
                                ...
                                Text("Wrist flexion exercise animation")
                                    .font(.body)
                                    .padding(10)
                                ...
                                Text("1. Begin with your wrist in a neutral position,with ulnar side (pinky side) facing the camera neither flexed nor extended. Your fingers should be relaxed")
                                    .font(.body)
                                    .foregroundColor(Colours.primaryTextColour)
                                    .padding(10)
                        ...
                        case .wristExtension:
                            ...
                            if viewModel.exercise?.hand == true {
                                ...
                                Text("Wrist extension exercise animation")
                                    .font(.body)
                                    .padding(10)
                                    .foregroundColor(Colours.primaryTextColour)
                        ...
                        case .ulnarDeviation:
                            ...
                            if viewModel.exercise?.hand == true {
                                ...
                                Text("Ulnar deviation exercise animation")
                                    .font(.body)
                                    .padding(10)
                                    .foregroundColor(Colours.primaryTextColour)
                                ...
                                Image("Instructions/ulnar_neutral_left")
                                    ...
                                    .aspectRatio(contentMode: .fit)
                                    .padding(31)
                                Text("1. Begin with your wrist in a neutral position,with back of hand facing camera neither deviated towards the ulnar side (pinky side) nor the radial side (thumb side). Keep your fingers relaxed")
                                    .font(.body)
                                    .padding(10)
                                    .foregroundColor(Colours.primaryTextColour)
                        ...
                        case .radialDeviation:
                            ...
                            if viewModel.exercise?.hand == true {
                                ...
                                Text("Radial deviation exercise animation")
                                    .font(.body)
                                    .padding(10)
                                    .foregroundColor(Colours.primaryTextColour)
                                ...
                                Image("Instructions/radial_neutral_left")
                                    ...
                                    .aspectRatio(contentMode: .fit)
                                    .padding(31)
                                Text("1. Begin with your wrist in a neutral position,with palm facing camera neither deviated towards the ulnar side (pinky side) nor the radial side (thumb side). Keep your fingers relaxed")
                                    .font(.body)
                                    .foregroundColor(Colours.primaryTextColour)
                                    .padding(10)
